...
const targetTime = moment("2025-01-06 18:30:00"); // Waktu target Anda
...
let countDown = new Date('Jan 06, 2025 18:30:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hari ini, aku langitkan semua doa terbaik untuk kamu.", " ", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.", " ", "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", " ", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya.", " ", "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
  startDelay: 2000,
  speed: 75,
